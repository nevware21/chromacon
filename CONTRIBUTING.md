...
[Code of Conduct](https://github.com/nevware21/chromacon/blob/main/CODE_OF_CONDUCT.md)

[Contributing Guide](https://github.com/nevware21/chromacon/blob/main/CONTRIBUTING.md)

[GitHub Issues](https://github.com/nevware21/chromacon/issues)

## Clone and setup

1. Clone the repository and create a new branch
	```
	git clone https://github.com/nevware21/chromacon.git
	```
