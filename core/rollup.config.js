...
const outputName = "chromacon";
const banner = [
    "/*!",
    ` * NevWare21 Solutions LLC - chromacon, ${version}`,
...
function sourcemapTransformer(options) {
    let githubRawUrl = "https://raw.githubusercontent.com/nevware21/chromacon/refs/tags/" + version + "/";
